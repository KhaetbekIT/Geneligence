...
export const HTMLDesign = () => {
	return (
		<div className="p-4 bg-white shadow-2xl rounded-4xl">
			<div className="bg-gradient-to-b from-[#74B4EF]/40 to-[#1B99FB] p-4 sm:p-8 rounded-4xl space-y-16">
				<div className="space-y-6">
					...
					<div className="space-y-4 max-w-xl ">
						...
						<p className="text-[#E3E3E3] text-justify">
							Адаптивная верстка сайтов по макету с мобильной оптимизацией и
							SEO-настройкой. Чистый валидный код, кроссбраузерность и высокая
							скорость загрузки. Идеальное соответствие дизайну на всех
							устройствах.
						</p>
					</div>
				</div>
